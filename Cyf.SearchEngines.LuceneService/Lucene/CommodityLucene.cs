...
namespace Cyf.SearchEngines.LuceneService
{
    public class CommodityLucene
    {
        ...
        /// <returns></returns>
        public static List<User> QueryCommodity(int pageIndex, int pageSize, out int totalCount, string keyword, List<int> categoryIdList, string priceFilter, string priceOrderBy)
        {
            totalCount = 0;
            try
            {
