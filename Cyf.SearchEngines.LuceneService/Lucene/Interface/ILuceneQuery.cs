...
namespace Cyf.SearchEngines.LuceneService.Interface
{
    public interface ILuceneQuery
    {
        ...
        /// <returns></returns>
        List<User> QueryIndex(string queryString);
        ...
        /// <returns></returns>
        List<User> QueryIndexPage(string queryString, int pageIndex, int pageSize, out int totalCount, string priceFilter, string priceOrderBy);
    }
}
